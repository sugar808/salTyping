...
toggle.addEventListener('change', () => {
    if(!KanaArea.textContent) {
        KanaArea.innerText = 'Show Hiragana Here';
...
toggle2.addEventListener('change', () => {
    if(translation.textContent === '') {
        translation.innerText = 'You can see translation here';
...
submitBtn1.addEventListener('click', () => {
    if(reflectQuestion.value && reflectKana.value) {
        ...
        reflectQuestion.placeholder = 'Please input something';

        reflectKana.classList.add('notFilledIn');
        reflectKana.placeholder = 'Please input something';
...
document.addEventListener('keydown', (e) => {
    ...
    if(e.key === 'Escape' && end) {
        ...
        maxSpeed.innerText = '';
        q.innerText = 'Please Press Space';
        correct.innerText = '0';
        wrong.innerText = '0';
        accuracy.innerText = '0';
        reflectRoman.innerText = 'You can see all spelling here';
        caret.innerText = '';
...
const setWord = () => {
    ...
    if(translation.textContent) {
        translation.innerText = translations[selectedDisplay];
...
const timer = () => {
    reflectTime.innerText = 'Time：' + timeIndex + 's';
    setTime = setInterval(() => {
        timeIndex--;
        reflectTime.innerText = 'Time：' + timeIndex + 's';

        if(reflectTime.textContent == 'Time：0s') {
            ...
            if(record_correct[1]) {
                lastRecords.innerText = '>>Last Records';
                lastRecord_correct.innerText = 'Correct：' + record_correct[0];
                lastRecord_wrong.innerText = 'Wrong：' + record_wrong[0];
